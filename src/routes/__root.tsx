...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      // PWA (CLAUDE.md §18) — cor da barra do navegador/status bar no mobile.
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    // Correção de acessibilidade (CLAUDE.md §16): o conteúdo é todo em
    // português; `lang="en"` faz leitor de tela pronunciar tudo errado.
    // Sem impacto visual.
    <html lang="pt-BR">
      <head>
        <HeadContent />
